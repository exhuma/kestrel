        ...
        <div class="sessions scroll">
          <div v-for="w in workflows" :key="w.id" class="scard-wrap">
            <button
              ...
              @click="select(w.id)"
            >
              <span class="scard__id mono"
                >{{ w.repo }}#{{ w.issue_number }}</span
              >
    ...
    <section class="stage">
      ...
      <header class="stage__head" v-if="current">
        ...
        <div class="tracker">
          ...
          <span
            class="tracker__step"
            :class="current.pr_url ? 't-ok' : 't-sys'"
          >
      ...
      <div class="stage__body scroll" v-if="current">
            ...
            >
              ...
              <span class="chip__text">
                ...
                <span
                  ...
                  class="chip__activity chip__activity--err mono"
                  >{{ s.error }}</span
                >
                <span v-else-if="s.activity" class="chip__activity mono">{{
                  s.activity
                }}</span>
              </span>
            </button>
        ...
        <div
          ...
          class="working working--attention"
          role="status"
        >
          <span
            class="working__pulse working__pulse--warn"
            aria-hidden="true"
          />
          <span class="mono">
            {{ activeStep?.name }} —
