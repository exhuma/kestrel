...
// The repository URL is baked in at build time (VITE_GITHUB_REPO_URL). When it
// is absent or blank the link is hidden entirely — never hard-code a URL, and
// never read one from user input.
